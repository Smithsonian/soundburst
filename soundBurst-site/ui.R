          ...
          hidden(div(id = "species-sidebox-container",
              div(id = "species-sidebox",
                  div(id = "site-info-container",
                      hidden(div(id = "dep-name-warning", "Attention: Please make sure this field is filled out.")),
                      ...
                      hidden(div(id = "recid-name-warning", "Attention: Please make sure this field is filled out.")),
